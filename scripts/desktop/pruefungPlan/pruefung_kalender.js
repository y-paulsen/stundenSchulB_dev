...
jQuery.getScript( "https://uicdn.toast.com/calendar/latest/toastui-calendar.min.js" )
  .done(function( script, textStatus ) {
    ...
    jQuery('#column18').after(calendarDiv);
    ...
    jQuery('#column19').after(uLegend);
    jQuery('#column19').after(rLegend);
    jQuery('#column19').after(kfLegend);
    jQuery('#column20').after(aLegend);
    jQuery('#column20').after(hLegend);
